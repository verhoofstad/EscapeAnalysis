...
class JavaTempType {
    ...
    public JavaClass resolveToJavaClass(JavaClass superClass, JavaTypeSet superInterfaces) {
        JavaClass javaClass = new JavaClass(this.jarClass.name(), this.jarClass.accessFlags(), superClass,
                superInterfaces, this.jarFile);
    ...
    public JavaInterface resolveToJavaInterface(JavaTypeSet superInterfaces) {
        JavaInterface javaInterface = new JavaInterface(this.jarClass.name(), this.jarClass.accessFlags(),
                superInterfaces, this.jarFile);
        for (JavaTempMethod tempMethod : this.methods) {
