...
public class EscapeStatementVisitor {
    ...
    /*
     * Visit the assignment of a local variable with an trivial value. This happens
     * when a variable is assigned with the return value of a method.
     * 
     */
    ...
    /*
     * Visit the assignment of an instance field of a local variable with an trivial
     * value. This happens when a variable is assigned with the return value of a
     * method.
     * 
     */
